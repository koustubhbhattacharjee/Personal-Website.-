#!/usr/bin/env node
// Direct seed of data/ap-physics-1-unit-8-fluids-mcq.json into Supabase.
...
const SOURCE_LABEL   = "AP Physics 1 Unit 8 Fluids MCQ — 2026-04-21"
const JSON_PATH      = path.join(process.cwd(), "data", "ap-physics-1-unit-8-fluids-mcq.json")
